...
<div class="mainindex">
    ...
    <div class="welinfo">
        ...
        <b>${sessionScope.loginUser.username}你好，欢迎使用在线阅读系统</b>(${sessionScope.loginUser.email})
        <a href="#">帐号设置</a>
    </div>
...
<%--    </div>--%>
    ...
    <ul class="infolist">
        <li><span>您可以进行文章发布管理操作</span><a class="ibtn">发布或管理文章</a></li>
        <li><span>您可以进行书库管理</span><a class="ibtn">在线阅读</a></li>
